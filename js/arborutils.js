...
(function($){
    ...
    var that = {
      ...
      redraw:function(){
        ...
        particleSystem.eachNode(function(node, pt){
          ...
          gfx.oval(pt.x-w/2, pt.y-w/2, w, w, {fill:"gray"})
          var w = 16
  ...
  $(document).ready(function(){
    ...
    sys.renderer = Renderer("#div-graphview") // our newly created renderer will have its .init() method called shortly by sys...
